...
import {
  ...
  getDefaultWallets,
  wait
} from "./chunk-YYV3EYBL.js";
import {
  AccentFailIcon,
  PoweredByThirdweb,
  TOS
} from "./chunk-QNSQ2KC5.js";
import {
  InputSelectionUI,
  LoadingScreen,
  ScreenSetupContext,
...
} from "./chunk-46Q45HAB.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
} from "./chunk-ZWMFLLMA.js";
import {
  WalletButtonEl
} from "./chunk-HGM263KQ.js";
import {
  Input,
  Label,
  Spinner,
  ...
  useSetSelectionData
} from "./chunk-LMQWTPG2.js";
import {
  WalletLogoSpinner
} from "./chunk-RACP74RH.js";
import {
  WalletImage,
  useActiveWallet
} from "./chunk-TKXVA2XB.js";
import {
  ArrowRightIcon,
  Button,
  ButtonLink,
  ...
  useWalletBalance,
  useWalletInfo
} from "./chunk-HQIMNT57.js";
import {
  deleteConnectParamsFromStorage
} from "./chunk-RMLEFI72.js";
import {
  getNFT
} from "./chunk-ZYWHPQCG.js";
import {
  getNFT as getNFT2
} from "./chunk-URRLN5F5.js";
import {
  getCurrencyMetadata
} from "./chunk-4GKRDBKJ.js";
import {
  isInAppWallet
} from "./chunk-W26VDA5H.js";
import {
  decimals
...
import {
  polygon
} from "./chunk-SWHZUSCS.js";
import {
  ethereum
} from "./chunk-XBQMN6VB.js";
import {
  getProfiles
...
} from "./chunk-ISBTSDQI.js";
import {
  createWallet,
  isMobile
} from "./chunk-YWAESAFM.js";
import {
  getWalletBalance
} from "./chunk-7PWXRMAD.js";
import {
  isEcosystemWallet
} from "./chunk-A4QFHV6F.js";
import {
...
import {
  smartWallet
} from "./chunk-XWBBQIUR.js";
import {
  isContractDeployed
} from "./chunk-TJZZUOQ3.js";
import {
  COINBASE
...
import {
  ...
  getChainSymbol,
  withCache
} from "./chunk-6QWQOHCG.js";
import {
  getThirdwebDomains
} from "./chunk-6SJGCNT7.js";
import {
  getClientFetch
} from "./chunk-SSTIDLY4.js";
import {
  __toESM
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-JHIRDR6Q.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-GED3BFLQ.js"),
              import("./in-app-core-635SXZ5Q.js")
            ]);
...
var BuyScreen = (0, import_react35.lazy)(() => import("./BuyScreen-HU6OJV2L.js"));
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react40.lazy)(() => import("./AllWalletsUI-5WBACJL3.js"));
...
var InAppWalletConnectUI = (0, import_react42.lazy)(() => import("./InAppWalletConnectUI-ZPKTTI25.js"));
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-KM23W22D.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-P36VATA4.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-227G74TJ.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-ARDJQFNX.js");
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-GXHKBRHP.js");
...
//# sourceMappingURL=chunk-JHBX3GGC.js.map
