    ...
    switch (request.method) {
      case "personal_sign": {
        if (handlers == null ? void 0 : handlers.personal_sign) {
          ...
          const { handleSignRequest } = await import("./sign-4XTEOCVE.js");
      ...
      case "eth_signTypedData": {
        if (handlers == null ? void 0 : handlers.eth_signTypedData) {
          ...
          const { handleSignTypedDataRequest } = await import("./sign-typed-data-VR5R5U7O.js");
      ...
      case "eth_signTransaction": {
        if (handlers == null ? void 0 : handlers.eth_signTransaction) {
          ...
          const { handleSignTransactionRequest } = await import("./sign-transaction-E64FNERN.js");
      ...
      case "eth_sendTransaction": {
        ...
        if (handlers == null ? void 0 : handlers.eth_sendTransaction) {
          ...
          const { handleSendTransactionRequest } = await import("./send-transaction-6TO43T2J.js");
      ...
      case "eth_sendRawTransaction": {
        ...
        if (handlers == null ? void 0 : handlers.eth_sendRawTransaction) {
          ...
          const { handleSendRawTransactionRequest } = await import("./send-raw-transaction-YOKHFMQM.js");
      ...
      case "wallet_switchEthereumChain": {
        if (handlers == null ? void 0 : handlers.wallet_switchEthereumChain) {
          ...
          const { handleSwitchChain } = await import("./switch-chain-MYAVR5A2.js");
...
//# sourceMappingURL=session-request-4ZCN2YFU.js.map
