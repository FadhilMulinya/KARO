...
import {
  ...
  getDefaultWallets,
  wait
} from "./chunk-EIKDT5SU.js";
import {
  AccentFailIcon,
  PoweredByThirdweb,
  TOS
} from "./chunk-5MCTJ7A4.js";
import {
  InputSelectionUI,
  LoadingScreen,
  ScreenSetupContext,
...
} from "./chunk-2ZVG7NN6.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
} from "./chunk-SPX6KQLU.js";
import {
  WalletButtonEl
} from "./chunk-FPHSHO7S.js";
import {
  Input,
  Label,
  Spinner,
  ...
  useSetSelectionData
} from "./chunk-5RM4BEA4.js";
import {
  WalletLogoSpinner
} from "./chunk-MPWTEYJD.js";
import {
  WalletImage,
  useActiveWallet
} from "./chunk-ISXYCHQJ.js";
import {
  ArrowRightIcon,
  Button,
  ButtonLink,
  ...
  useWalletBalance,
  useWalletInfo
} from "./chunk-KDQVVEZ3.js";
import {
  deleteConnectParamsFromStorage
} from "./chunk-RMLEFI72.js";
import {
  getNFT
} from "./chunk-T3EP65WV.js";
import {
  getNFT as getNFT2
} from "./chunk-VB66R4QY.js";
import {
  getCurrencyMetadata
} from "./chunk-6HE7JGJ7.js";
import {
  isInAppWallet
} from "./chunk-PK25PCOQ.js";
import {
  resolveArweaveScheme
} from "./chunk-FTGVVEWF.js";
import {
  decimals
} from "./chunk-WAB4GE2Z.js";
import {
  getProfiles
...
} from "./chunk-TZRP7C57.js";
import {
  createWallet,
  isMobile
} from "./chunk-J5EIIN7I.js";
import {
  getWalletBalance
} from "./chunk-BRU5IXRE.js";
import {
  isEcosystemWallet
} from "./chunk-5H47AB5M.js";
import {
...
} from "./chunk-5TUD5A7Y.js";
import {
  sendAndConfirmTransaction
} from "./chunk-KV7UIEZG.js";
import {
  NATIVE_TOKEN_ADDRESS
} from "./chunk-F2NDM2JU.js";
import {
  waitForReceipt
} from "./chunk-5UMPSIOZ.js";
import {
  once,
  prepareContractCall
} from "./chunk-TOLLXXKE.js";
import {
  eth_getBalance
} from "./chunk-OULA2JUL.js";
import {
  sendTransaction
} from "./chunk-YXDWDMRE.js";
import {
  createStore,
  getTransactionStore
...
import {
  getGasPrice
} from "./chunk-QZO2K6UY.js";
import {
  resolvePromisedValue
} from "./chunk-2FH4XCFL.js";
import {
  resolveScheme
} from "./chunk-SHLB24UB.js";
import {
  toTokens,
  toUnits,
  toWei
...
import {
  getRpcClient
} from "./chunk-BFYMVFVP.js";
import {
  encodeAbiParameters
} from "./chunk-YQ3CEJLX.js";
import {
  getAddress,
  isAddress,
  shortenAddress,
  shortenHex
} from "./chunk-CLWLXFWW.js";
import {
  toHex
} from "./chunk-BNK74YTA.js";
import {
  hexToNumber
} from "./chunk-CJ2CQ55J.js";
import {
  polygon
} from "./chunk-D6WWNYLX.js";
import {
  ethereum
} from "./chunk-C3PFS3TX.js";
import {
  cacheChains,
  ...
  getChainSymbol,
  withCache
} from "./chunk-TESS5WGS.js";
import {
  getThirdwebDomains
} from "./chunk-6SJGCNT7.js";
import {
  getClientFetch
} from "./chunk-3R4VSFDT.js";
import {
  require_react
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-XVDWXJCB.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-FXCNQPKC.js"),
              import("./in-app-core-TOJBNACD.js")
            ]);
...
var NetworkTabContent = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(Container, { scrollY: true, animate: "fadein", style: {
    ...
    return (0, import_jsx_runtime24.jsxs)(import_react20.Fragment, { children: [idx !== 0 && (0, import_jsx_runtime24.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime24.jsx)(SectionLabel, { children: section.label }), (0, import_jsx_runtime24.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime24.jsx)(NetworkList, { chains: section.chains, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close, client: props.client, connectLocale: props.connectLocale })] }, section.label);
  }) });
};
...
function TokenInfoRow(props) {
  const chainObj = (0, import_react22.useMemo)(() => getCachedChain(props.chainId), [props.chainId]);
...
function FiatSteps(props) {
  ...
  const toChain = (0, import_react24.useMemo)(() => getCachedChain(toTokenMeta.chainId), [toTokenMeta.chainId]);
  const destinationChain = (0, import_react24.useMemo)(() => {
    var _a2, _b2, _c2;
  ...
  const onRampChain = (0, import_react24.useMemo)(() => getCachedChain(onRampTokenMeta.chainId), [onRampTokenMeta.chainId]);
  const onRampToken = (0, import_react24.useMemo)(() => {
...
function SwapConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react25.useState)(initialStep);
  ...
  return (0, import_jsx_runtime42.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime42.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.isFiatFlow ? (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime42.jsx)(StepBar, { steps: 2, currentStep: 2 }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime42.jsxs)(Text, { size: "xs", children: ["Step 2 of 2 - Converting ", props.fromTokenSymbol, " to", " ", props.toTokenSymbol] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "md" })] }) : (0, import_jsx_runtime42.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime42.jsx)(ConfirmItem, { label: "Pay", children: (0, import_jsx_runtime42.jsx)(RenderTokenInfo, { chain: props.fromChain, amount: String(formatNumber(Number(props.fromAmount), 6)), symbol: props.fromTokenSymbol || "", token: props.fromToken, client: props.client }) }), !isDifferentRecipient && (0, import_jsx_runtime42.jsx)(ConfirmItem, { label: "Receive", children: (0, import_jsx_runtime42.jsx)(RenderTokenInfo, { chain: props.toChain, amount: String(formatNumber(Number(props.toAmount), 6)), symbol: props.toTokenSymbol, token: props.toToken, client: props.client }) }), (0, import_jsx_runtime42.jsx)(ConfirmItem, { label: "Fees", children: (0, import_jsx_runtime42.jsx)(SwapFeesRightAligned, { quote: props.quote }) }), (0, import_jsx_runtime42.jsx)(ConfirmItem, { label: "Time", children: (0, import_jsx_runtime42.jsxs)(Text, { size: "sm", color: "primaryText", children: ["~", formatSeconds(props.quote.swapDetails.estimated.durationSeconds || 0)] }) }), isDifferentRecipient && (0, import_jsx_runtime42.jsx)(ConfirmItem, { label: "Seller", children: (0, import_jsx_runtime42.jsx)(Text, { color: "primaryText", size: "sm", children: ensName.data || shortenAddress(receiver) }) }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xl" }), isApprovalRequired && (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime42.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime42.jsx)(Step, { isDone: step === "swap", isActive: step === "approval", label: step === "approval" ? "Approve" : "Approved" }), (0, import_jsx_runtime42.jsx)(ConnectorLine, {}), (0, import_jsx_runtime42.jsx)(Step, { isDone: false, label: "Confirm", isActive: step === "swap" })] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "lg" })] }), status === "error" && (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, import_jsx_runtime42.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime42.jsx)(Text, { color: "danger", size: "sm", children: step === "approval" ? "Failed to Approve" : "Failed to Confirm" })] }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "md" })] }), props.payer.chain.id !== props.fromChain.id ? (0, import_jsx_runtime42.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(props.fromChain);
  } }) : (0, import_jsx_runtime42.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
  ...
  }, gap: "xs", children: [step === "approval" && (status === "pending" ? "Approving" : "Approve"), step === "swap" && (status === "pending" ? "Confirming" : "Confirm"), status === "pending" && (0, import_jsx_runtime42.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}
...
function RenderTokenInfo(props) {
  const { name } = useChainName(props.chain);
  return (0, import_jsx_runtime42.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime42.jsxs)(Container, { flex: "row", center: "y", gap: "xs", children: [(0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", size: "sm", children: [props.amount, " ", props.symbol] }), (0, import_jsx_runtime42.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "xs", client: props.client })] }), name ? (0, import_jsx_runtime42.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime42.jsx)(Skeleton, { width: "100px", height: fontSize.xs })] });
}
function ConfirmItem(props) {
  return (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [(0, import_jsx_runtime42.jsxs)(Container, { flex: "row", gap: "md", py: "md", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime42.jsx)(Text, { size: "sm", color: "secondaryText", children: props.label }), props.children] }), (0, import_jsx_runtime42.jsx)(Line, {})] });
}
function SwapFeesRightAligned(props) {
  return (0, import_jsx_runtime42.jsx)(Container, { flex: "column", gap: "xs", style: {
    ...
    return (0, import_jsx_runtime42.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", size: "sm", children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime42.jsxs)(Text, { color: "secondaryText", size: "sm", children: ["($", (fee.amountUSDCents / 100).toFixed(2), ")"] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
...
function SwapDetailsScreen(props) {
  ...
  return (0, import_jsx_runtime43.jsxs)(Container, { children: [(0, import_jsx_runtime43.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime43.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime43.jsx)(Line, {}), (0, import_jsx_runtime43.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime43.jsx)(SwapTxDetailsTable, { type: "status", status, client }) })] });
}
function SwapTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime43.jsx)(Line, {}), (0, import_jsx_runtime43.jsx)(Spacer, { y: "md" })] });
  if (isTransfer) {
    return (0, import_jsx_runtime43.jsx)("div", { children: ((_d = (_c = fromChainExplorers.explorers) == null ? void 0 : _c[0]) == null ? void 0 : _d.url) && sourceTxHash && (0, import_jsx_runtime43.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
      fontSize: fontSize.sm,
      padding: spacing.sm
    }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime43.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }) });
  }
  return (0, import_jsx_runtime43.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
    // Expected + Got
    (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: isPartialSuccess ? "Expected" : "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address }), lineSpacer, (0, import_jsx_runtime43.jsx)(TokenInfoRow, { chainId: gotToken.chainId, client, label: "Got", tokenAmount: gotToken.amount, tokenSymbol: gotToken.symbol || "", tokenAddress: gotToken.address })] })
  ) : (
    // Receive
    (0, import_jsx_runtime43.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: "Receive", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })
  ), lineSpacer, (0, import_jsx_runtime43.jsx)(TokenInfoRow, { chainId: fromToken.chainId, client, label: "Pay", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, (0, import_jsx_runtime43.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime43.jsx)(Text, { children: " Time " }), (0, import_jsx_runtime43.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime43.jsxs)(Text, { color: "primaryText", children: ["~", formatSeconds(estimatedDuration || 0)] }) })] }), statusMeta && showStatusRow && (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [lineSpacer, (0, import_jsx_runtime43.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime43.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime43.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime43.jsx)(Text, { color: statusMeta.color, children: statusMeta.status }) })] })] }), uiData.fromAddress.toLowerCase() !== uiData.toAddress.toLowerCase() && (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [lineSpacer, (0, import_jsx_runtime43.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime43.jsx)(Text, { children: "Send to" }), (0, import_jsx_runtime43.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime43.jsx)(Text, { color: "primaryText", size: "sm", children: shortenAddress(uiData.toAddress) }) })] })] }), lineSpacer, ((_f = (_e = fromChainExplorers.explorers) == null ? void 0 : _e[0]) == null ? void 0 : _f.url) && sourceTxHash && (0, import_jsx_runtime43.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime43.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }), destinationTxHash && sourceTxHash !== destinationTxHash && ((_h = (_g = toChainExplorers == null ? void 0 : toChainExplorers.explorers) == null ? void 0 : _g[0]) == null ? void 0 : _h.url) && (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime43.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainExplorers.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", toChainName.name, " Explorer", (0, import_jsx_runtime43.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function SwapStatusScreen(props) {
  ...
  const purchaseCbCalled = (0, import_react26.useRef)(false);
  ...
  const queryClient = useQueryClient();
  const balanceInvalidated = (0, import_react26.useRef)(false);
  (0, import_react26.useEffect)(() => {
  ...
  const swapDetails = swapStatus.data && swapStatus.data.status !== "NOT_FOUND" ? (0, import_jsx_runtime44.jsx)(SwapTxDetailsTable, { status: swapStatus.data, type: "status", hideStatusRow: true, client: props.client }) : props.quote ? (0, import_jsx_runtime44.jsx)(SwapTxDetailsTable, { type: "quote", quote: props.quote, client: props.client }) : null;
  return (0, import_jsx_runtime44.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime44.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime44.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), uiStatus === "success" && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime44.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime44.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime44.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Complete" })] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), swapDetails, (0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), !props.isEmbed && (0, import_jsx_runtime44.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] }), uiStatus === "partialSuccess" && ((_e = swapStatus.data) == null ? void 0 : _e.status) !== "NOT_FOUND" && ((_f = swapStatus.data) == null ? void 0 : _f.destination) && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime44.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime44.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime44.jsx)(Text, { color: "primaryText", size: "lg", children: "Incomplete" }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime44.jsxs)(Text, { size: "sm", color: "danger", children: ["Expected ", swapStatus.data.quote.toToken.symbol, ", Got", " ", swapStatus.data.destination.token.symbol, " instead"] })] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), swapDetails] }), uiStatus === "failed" && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime44.jsxs)(Container, { flex: "column", children: [(0, import_jsx_runtime44.jsxs)(Container, { flex: "column", center: "both", children: [(0, import_jsx_runtime44.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime44.jsx)(Text, { color: "primaryText", size: "lg", children: "Transaction Failed" }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime44.jsxs)(Text, { size: "sm", children: ["Your transaction ", `couldn't`, " be processed"] })] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime44.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onTryAgain, children: "Try Again" }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), swapDetails] })] }), uiStatus === "pending" && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime44.jsxs)(Container, { flex: "column", animate: "fadein", center: "both", children: [(0, import_jsx_runtime44.jsx)("div", { style: {
    position: "relative",
    display: "flex",
    alignItems: "center",
    justifyContent: "center"
  }, children: (0, import_jsx_runtime44.jsx)(Spinner, { size: "3xl", color: "accentText" }) }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime44.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Pending" })] }), (0, import_jsx_runtime44.jsx)(Spacer, { y: "xxl" }), swapDetails] })] }) });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/SwapFlow.js
function SwapFlow(props) {
  const [swapTxHash, setSwapTxHash] = (0, import_react27.useState)();
  const quote = props.buyWithCryptoQuote;
  const fromChain = (0, import_react27.useMemo)(() => getCachedChain(quote.swapDetails.fromToken.chainId), [quote]);
  const toChain = (0, import_react27.useMemo)(() => getCachedChain(quote.swapDetails.toToken.chainId), [quote]);
  ...
  const toToken = (0, import_react27.useMemo)(() => {
  ...
  const fromToken = (0, import_react27.useMemo)(() => {
  ...
  if (swapTxHash) {
    return (0, import_jsx_runtime45.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime45.jsx)(SwapConfirmationScreen, { title: props.title, setSwapTxHash, toChain, toAmount, toTokenSymbol, fromChain, toToken, fromAmount, fromToken, fromTokenSymbol, client: props.client, onBack: props.onBack, onTryAgain: props.onTryAgain, quote, isFiatFlow: props.isFiatFlow, payer: props.payer });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/PostOnRampSwap.js
function PostOnRampSwap(props) {
  const [lockedOnRampQuote, setLockedOnRampQuote] = (0, import_react28.useState)(void 0);
  ...
  if (postOnRampQuoteQuery.isError) {
    return (0, import_jsx_runtime46.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime46.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime46.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime46.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", p: "lg", children: [(0, import_jsx_runtime46.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime46.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime46.jsx)(Text, { color: "primaryText", children: "Failed to get a price quote" }), (0, import_jsx_runtime46.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime46.jsx)(Button, { fullWidth: true, variant: "primary", onClick: () => {
      postOnRampQuoteQuery.refetch();
    }, children: "Try Again" })] }), (0, import_jsx_runtime46.jsx)(Spacer, { y: "xxl" })] });
  }
  if (!lockedOnRampQuote) {
    return (0, import_jsx_runtime46.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime46.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime46.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime46.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", children: [(0, import_jsx_runtime46.jsx)(Spinner, { size: "xxl", color: "accentText" }), (0, import_jsx_runtime46.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime46.jsx)(Text, { color: "primaryText", children: "Getting price quote" })] }), (0, import_jsx_runtime46.jsx)(Spacer, { y: "xxl" })] });
  }
  return (0, import_jsx_runtime46.jsx)(SwapFlow, { title: props.title, payer: props.payer, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
...
function PostOnRampSwapFlow(props) {
  const [statusForSwap, setStatusForSwap] = (0, import_react29.useState)();
  if (statusForSwap) {
    return (0, import_jsx_runtime47.jsx)(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime47.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
...
function FiatDetailsScreen(props) {
  ...
  const [stopPolling, setStopPolling] = (0, import_react30.useState)(false);
  ...
  if (hasTwoSteps) {
    ...
    return (0, import_jsx_runtime48.jsx)(PostOnRampSwapFlow, {
      title: props.title,
      client: props.client,
      status,
      onBack: props.onBack,
  ...
  return (0, import_jsx_runtime48.jsxs)(Container, { children: [(0, import_jsx_runtime48.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime48.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime48.jsx)(Line, {}), (0, import_jsx_runtime48.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime48.jsx)(OnRampTxDetailsTable, { client: props.client, token: status.source ? {
...
function TxDetailsScreen(props) {
  ...
  if (statusInfo.type === "swap") {
    return (0, import_jsx_runtime49.jsx)(SwapDetailsScreen, { client: props.client, status: statusInfo.status, onBack: props.onBack });
  }
  if (statusInfo.type === "fiat") {
    return (0, import_jsx_runtime49.jsx)(FiatDetailsScreen, { title: props.title, client: props.client, status: statusInfo.status, onBack: props.onBack, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer });
  }
  return null;
}
...
function useBuyTransactionsToShow(client) {
  ...
  const [pageIndex, setPageIndex] = (0, import_react31.useState)(0);
  const txStatusList = [];
  const PAGE_SIZE = 10;
  ...
  const pendingTxStoreValue = (0, import_react31.useSyncExternalStore)(pendingTransactions.subscribe, pendingTransactions.getValue);
...
function PayTxHistoryList(props) {
  ...
  return (0, import_jsx_runtime50.jsxs)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    width: "100%",
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime50.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [noTransactions && !isLoading && (0, import_jsx_runtime50.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime50.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime50.jsx)(Text, { children: "No Transactions" })] }), noTransactions && isLoading && (0, import_jsx_runtime50.jsx)(Container, { flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime50.jsx)(Spinner, { size: "xl", color: "accentText" }) }), txInfosToShow.length > 0 && (0, import_jsx_runtime50.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
    var _a;
    return (0, import_jsx_runtime50.jsx)(BuyTxHistoryButton, { txInfo, client: props.client, onClick: () => {
      props.onSelectTx(txInfo);
    } }, txInfo.type === "swap" ? (_a = txInfo.status.source) == null ? void 0 : _a.transactionHash : txInfo.status.intentId);
  }) }), isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime50.jsxs)(import_jsx_runtime50.Fragment, { children: [(0, import_jsx_runtime50.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime50.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime50.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] })] }), pagination && !hidePagination && (0, import_jsx_runtime50.jsx)(Container, { py: "md", children: (0, import_jsx_runtime50.jsxs)("div", { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: spacing.sm
  }, children: [(0, import_jsx_runtime50.jsxs)(Button, { variant: "outline", gap: "xs", disabled: pageIndex === 0, "data-disabled": pageIndex === 0, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev - 1);
  }, children: [(0, import_jsx_runtime50.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "rotate(180deg)"
  } }), "Prev"] }), (0, import_jsx_runtime50.jsxs)(Button, { variant: "outline", gap: "xs", disabled: !pagination.hasNextPage, "data-disabled": !pagination.hasNextPage, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev + 1);
  }, children: ["Next", (0, import_jsx_runtime50.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] }) })] });
}
...
function WalletTransactionHistory(props) {
  ...
  const reverseChronologicalTransactions = (0, import_react33.useSyncExternalStore)(transactionStore.subscribe, transactionStore.getValue);
  const transactions = [...reverseChronologicalTransactions].reverse();
  return (0, import_jsx_runtime51.jsx)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: (0, import_jsx_runtime51.jsx)(Container, { flex: "column", gap: "xs", expand: true, children: transactions.length === 0 ? (0, import_jsx_runtime51.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    flex: "1",
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime51.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime51.jsx)(Text, { children: "No Transactions" })] }) : (0, import_jsx_runtime51.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", style: { minHeight: "250px" }, children: transactions.map((tx) => {
    var _a;
    return (0, import_jsx_runtime51.jsx)(TransactionButton, { explorerUrl: (_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url, client: props.client, hash: tx.transactionHash, chainId: tx.chainId }, tx.transactionHash);
  }) }) }) });
}
function TransactionButton(props) {
  ...
  const content = (0, import_jsx_runtime51.jsxs)(TxButton2, { variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime51.jsxs)(Container, { flex: "row", center: "y", gap: "md", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime51.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, client: props.client }), (0, import_jsx_runtime51.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime51.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime51.jsx)(Text, { size: "sm", color: "primaryText", children: (receipt == null ? void 0 : receipt.to) ? `Interacted with ${shortenHex(receipt.to, 4)}` : `Hash: ${shortenHex(props.hash, 4)}` }) }), (0, import_jsx_runtime51.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime51.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime51.jsx)(ChainName, { chain: getCachedChain(props.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime51.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [isLoading && (0, import_jsx_runtime51.jsx)(Spinner, { size: "sm", color: "primaryText" }), !isLoading && receipt && receipt.status === "success" && (0, import_jsx_runtime51.jsx)(Text, { size: "md", color: "success", children: (0, import_jsx_runtime51.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md }) }), (error || !isLoading && receipt && receipt.status !== "success") && (0, import_jsx_runtime51.jsx)(Text, { size: "md", color: "danger", children: (0, import_jsx_runtime51.jsx)(CrossCircledIcon, { width: iconSize.md, height: iconSize.md }) })] })] });
  if (props.explorerUrl) {
    return (0, import_jsx_runtime51.jsx)("a", { href: `${props.explorerUrl}/tx/${props.hash}`, target: "_blank", rel: "noreferrer", children: content });
  }
  return content;
}
...
function TransactionsScreen(props) {
  var _a;
  const [activeTab, setActiveTab] = (0, import_react34.useState)("Transactions");
  const [selectedTx, setSelectedTx] = (0, import_react34.useState)(null);
  const activeChain = useActiveWalletChain();
  ...
  if (!payer) {
    return (0, import_jsx_runtime52.jsx)(LoadingScreen, {});
  }
  if (selectedTx) {
    return (0, import_jsx_runtime52.jsx)(TxDetailsScreen, { title: props.title, client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: () => setSelectedTx(null), payer, transactionMode: false, isEmbed: false });
  }
  return (0, import_jsx_runtime52.jsxs)(Container, { animate: "fadein", children: [(0, import_jsx_runtime52.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime52.jsx)(ModalHeader, { title: props.locale.transactions, onBack: props.onBack }) }), (0, import_jsx_runtime52.jsx)(Line, {}), (0, import_jsx_runtime52.jsxs)(Container, { px: "lg", scrollY: true, style: {
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime52.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime52.jsxs)(Tabs, { options: [
    {
      label: (0, import_jsx_runtime52.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime52.jsx)(CoinsIcon, { size: iconSize.sm }), " Transactions"] }),
      value: "Transactions"
    },
    {
      label: (0, import_jsx_runtime52.jsxs)("span", { className: "flex gap-2", children: [(0, import_jsx_runtime52.jsx)(FundsIcon, { size: iconSize.sm }), " Purchases"] }),
      value: "Purchases"
    }
  ], selected: activeTab, onSelect: setActiveTab, children: [activeTab === "Purchases" && (0, import_jsx_runtime52.jsx)(PayTxHistoryList, { client: props.client, onSelectTx: setSelectedTx }), activeTab === "Transactions" && (0, import_jsx_runtime52.jsx)(WalletTransactionHistory, { locale: props.locale, client: props.client, address: payer.account.address })] })] }), (0, import_jsx_runtime52.jsx)(Line, {}), (0, import_jsx_runtime52.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime52.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${(_a = chainExplorers.explorers[0]) == null ? void 0 : _a.url}/address/${activeAccount == null ? void 0 : activeAccount.address}`, target: "_blank", as: "a", gap: "xs", style: {
    textDecoration: "none",
    color: "inherit"
  }, children: ["View on Explorer", " ", (0, import_jsx_runtime52.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }) })] });
}
...
var OutlineWalletIcon = (props) => {
  return (0, import_jsx_runtime53.jsxs)("svg", { width: props.size, height: props.size, viewBox: "0 0 24 24", role: "presentation", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime53.jsx)("path", { d: "M19 7V4C19 3.73478 18.8946 3.48043 18.7071 3.29289C18.5196 3.10536 18.2652 3 18 3H5C4.46957 3 3.96086 3.21071 3.58579 3.58579C3.21071 3.96086 3 4.46957 3 5C3 5.53043 3.21071 6.03914 3.58579 6.41421C3.96086 6.78929 4.46957 7 5 7H20C20.2652 7 20.5196 7.10536 20.7071 7.29289C20.8946 7.48043 21 7.73478 21 8V12M21 12H18C17.4696 12 16.9609 12.2107 16.5858 12.5858C16.2107 12.9609 16 13.4696 16 14C16 14.5304 16.2107 15.0391 16.5858 15.4142C16.9609 15.7893 17.4696 16 18 16H21C21.2652 16 21.5196 15.8946 21.7071 15.7071C21.8946 15.5196 22 15.2652 22 15V13C22 12.7348 21.8946 12.4804 21.7071 12.2929C21.5196 12.1054 21.2652 12 21 12Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime53.jsx)("path", { d: "M3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H20C20.2652 21 20.5196 20.8946 20.7071 20.7071C20.8946 20.5196 21 20.2652 21 20V16", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/LazyBuyScreen.js
var import_jsx_runtime54 = __toESM(require_jsx_runtime(), 1);
var import_react35 = __toESM(require_react(), 1);
var BuyScreen = (0, import_react35.lazy)(() => import("./BuyScreen-4FIPYWI2.js"));
function LazyBuyScreen(props) {
  return (0, import_jsx_runtime54.jsx)(import_react35.Suspense, { fallback: (0, import_jsx_runtime54.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime54.jsx)(BuyScreen, { ...props }) });
}
...
function useConnectedWallets() {
  ...
  return (0, import_react36.useSyncExternalStore)(store.subscribe, store.getValue, store.getValue);
}
...
var SignatureScreen = (props) => {
  ...
  const signIn = (0, import_react38.useCallback)(async () => {
    try {
      setStatus("signing");
...
function HeadlessSignIn({ signIn, status, connectLocale, wallet }) {
  ...
  return (0, import_jsx_runtime55.jsxs)(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime55.jsx)(ModalHeader, { title: locale.signingScreen.title }), (0, import_jsx_runtime55.jsxs)(Container, { expand: true, flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: [status === "signing" && (0, import_jsx_runtime55.jsx)(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: (0, import_jsx_runtime55.jsxs)(Container, { children: [(0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime55.jsx)(Text, { size: "lg", center: true, color: "danger", children: locale.signingScreen.failedToSignIn }), (0, import_jsx_runtime55.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime55.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => {
    signIn();
  }, style: {
    gap: spacing.xs,
    alignItems: "center",
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react40.lazy)(() => import("./AllWalletsUI-FUUFNCTQ.js"));
var ConnectModalContent = (props) => {
  ...
  const handleConnected = (0, import_react40.useCallback)((wallet) => {
    if (shouldSetActive) {
  ...
  const handleBack = (0, import_react40.useCallback)(() => {
    setSelectionData({});
    setScreen(initialScreen);
...
function WalletManagerScreen(props) {
  var _a;
  const [screen, setScreen] = (0, import_react41.useState)("wallets");
  const connectedWallets = useConnectedWallets();
  ...
  return (0, import_jsx_runtime61.jsxs)(Container, { children: [(0, import_jsx_runtime61.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime61.jsx)(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, import_jsx_runtime61.jsx)(Line, {}), (0, import_jsx_runtime61.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime61.jsx)(Container, { px: "md", style: {
    minHeight: "150px"
  }, children: (0, import_jsx_runtime61.jsx)(Container, { flex: "column", gap: "xs", children: connectedWallets.map((w) => {
...
var InAppWalletConnectUI = (0, import_react42.lazy)(() => import("./InAppWalletConnectUI-RDSMGSNU.js"));
function LinkProfileScreen(props) {
  ...
  if (activeWallet.id === "inApp") {
    return (0, import_jsx_runtime62.jsx)(import_react42.Suspense, { fallback: (0, import_jsx_runtime62.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime62.jsx)(InAppWalletConnectUI, { walletConnect: props.walletConnect, wallet: activeWallet, done: () => {
...
function LinkedProfilesScreen(props) {
  ...
  return (0, import_jsx_runtime64.jsxs)(Container, { style: {
    ...
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime64.jsx)(AddUserIcon, { size: iconSize.md }), (0, import_jsx_runtime64.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkProfile })] }), (0, import_jsx_runtime64.jsx)(Spacer, { y: "xs" }), connectedProfiles == null ? void 0 : connectedProfiles.map((profile) => (0, import_jsx_runtime64.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("linked-profiles");
  }, style: {
    fontSize: fontSize.sm,
    cursor: "default"
  }, disabled: true, children: [profile.type === "wallet" && profile.details.address ? (0, import_jsx_runtime64.jsx)(Container, { style: {
    width: "24px",
    height: "24px",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: (0, import_jsx_runtime64.jsx)(Blobbie, { address: profile.details.address, size: 24 }) }) : (0, import_jsx_runtime64.jsx)(Img, { src: getWalletIcon(profile.type), width: iconSize.md, height: iconSize.md, loading: "eager", client: props.client }), (0, import_jsx_runtime64.jsx)(Text, { color: "primaryText", children: getProfileDisplayName(profile) })] }, `${profile.type}-${getProfileDisplayName(profile)}`))] }), (0, import_jsx_runtime64.jsx)(Spacer, { y: "md" })] })] });
}
...
function PrivateKey(props) {
  var _a;
  const [isLoading, setLoading] = (0, import_react43.useState)(true);
  if (!props.wallet) {
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-KIUN5OWH.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-UNTEZXFV.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-G7KSXQWX.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-FQM7E52L.js");
...
function TokenSelector(props) {
  const [screen, setScreen] = (0, import_react44.useState)("base");
  const [input, setInput] = (0, import_react44.useState)("");
...
function SendFunds(props) {
  const [screen, setScreen] = (0, import_react45.useState)("base");
  const activeChain = useActiveWalletChain();
  ...
  const [token, setToken] = (0, import_react45.useState)(defaultToken);
  const [receiverAddress, setReceiverAddress] = (0, import_react45.useState)("");
  const [amount, setAmount] = (0, import_react45.useState)("0");
  const chain = useActiveWalletChain();
...
function useResolvedMediaType(client, uri, mimeType, gatewayUrl) {
  const resolvedUrl = (0, import_react46.useMemo)(() => {
    if (!uri) {
      return "";
    }
...
// node_modules/thirdweb/dist/esm/react/web/ui/MediaRenderer/MediaRenderer.js
var MediaRenderer = (() => import_react47.default.forwardRef(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className }, ref) {
  var _a;
  const mergedStyle = {
    objectFit: "contain",
    ...style
  ...
  if (mediaInfo.mimeType) {
    ...
    if (mediaInfo.mimeType.startsWith("model")) {
      return (0, import_jsx_runtime75.jsx)(import_react47.Suspense, { fallback: poster ? (0, import_jsx_runtime75.jsx)("img", { style: mergedStyle, src: poster, alt, ref, className }) : null, children: (0, import_jsx_runtime75.jsx)(ModelViewer, { style: mergedStyle, src: mediaInfo.url || "", poster, alt, className }) });
    }
...
var ModelViewer = (0, import_react47.lazy)(() => import("./ModelViewer-ZH2VAWAX.js"));
var PlayButton = ({ onClick, isPlaying }) => {
  const [isHovering, setIsHovering] = (0, import_react47.useState)(false);
...
var ImageRenderer = (() => import_react47.default.forwardRef(function Image_Renderer(props, ref) {
...
var VideoPlayer = (() => import_react47.default.forwardRef(function Video_Player({ src, alt, poster, requireInteraction, style, width, height, controls, className }, ref) {
  const videoRef = (0, import_react47.useRef)(null);
  const [playing, setPlaying] = (0, import_react47.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react47.useState)(true);
  const [error, setError] = (0, import_react47.useState)(false);
...
var AudioPlayer = (() => import_react47.default.forwardRef(function Audio_Player({ src, alt, poster, style, height, width, className, controls }, ref) {
  const audioRef = (0, import_react47.useRef)(null);
  const [playing, setPlaying] = (0, import_react47.useState)(false);
  const [muted, setMuted] = (0, import_react47.useState)(true);
  const [error, setError] = (0, import_react47.useState)(false);
  (0, import_react47.useEffect)(() => {
    if (audioRef.current) {
...
var IframePlayer = (() => import_react47.default.forwardRef(function Iframe_Player({ src, alt, poster, requireInteraction, style, ...restProps }, ref) {
  const [playing, setPlaying] = (0, import_react47.useState)(!requireInteraction);
...
var LinkPlayer = (() => import_react47.default.forwardRef(function Link_Player({ src, alt, style, className }, ref) {
...
function ViewNFTsContent(props) {
  const activeAccount = useActiveAccount();
  const activeChain = useActiveWalletChain();
  const nftList = (0, import_react48.useMemo)(() => {
    const nfts = [];
...
function ViewAssets(props) {
  const [activeTab, setActiveTab] = (0, import_react49.useState)("Tokens");
  ...
  return (0, import_jsx_runtime78.jsxs)(Container, { animate: "fadein", style: {
    ...
    minHeight: "330px"
  }, children: [(0, import_jsx_runtime78.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime78.jsx)(Tabs, { options: [
    {
  ...
  ], selected: activeTab, onSelect: setActiveTab, children: (0, import_jsx_runtime78.jsxs)(Container, { scrollY: true, style: {
    maxHeight: "300px"
...
function WalletConnectReceiverScreen(props) {
  ...
  const [errorConnecting, setErrorConnecting] = (0, import_react50.useState)(false);
  const queryClient = useQueryClient();
...
var ConnectedWalletDetails = (props) => {
  ...
  const setRootEl = (0, import_react51.useContext)(SetRootElementContext);
  const activeAccount = useActiveAccount();
  ...
  return (0, import_jsx_runtime81.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${((_g = props.detailsButton) == null ? void 0 : _g.className) || ""}`, style: (_h = props.detailsButton) == null ? void 0 : _h.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, import_jsx_runtime81.jsx)(Container, { style: {
    borderRadius: "100%",
    overflow: "hidden",
    width: "35px",
    height: "35px"
...
function DetailsModal(props) {
  ...
  const [screen, setScreen] = (0, import_react51.useState)("main");
  const { disconnect } = useDisconnect();
  const [isOpen, setIsOpen] = (0, import_react51.useState)(true);
  ...
  let content = (0, import_jsx_runtime81.jsxs)("div", { children: [(0, import_jsx_runtime81.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime81.jsxs)(Container, { px: "lg", gap: "sm", flex: "row", center: "y", style: {
    ...
    setScreen("receive");
  }, children: [(0, import_jsx_runtime81.jsxs)(Container, { color: "secondaryText", flex: "row", center: "both", children: [(0, import_jsx_runtime81.jsx)(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }), " "] }), locale.receive, " "] }), !hideBuyFunds && (0, import_jsx_runtime81.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime81.jsx)(TextAlignJustifyIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime81.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime81.jsx)(Text, { color: "primaryText", children: locale.transactions }) })] }), (0, import_jsx_runtime81.jsxs)(MenuButton, { onClick: () => {
  ...
  if (screen === "network-switcher") {
    ...
    content = (0, import_jsx_runtime81.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_s = props.detailsModal) == null ? void 0 : _s.payOptions) || {
      mode: "fund_wallet"
...
function ConnectedToSmartWallet(props) {
  ...
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = (0, import_react51.useState)(false);
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-DDDFBL2K.js");
  ...
  if (userInfoQuery.data || walletInfo) {
    return (0, import_jsx_runtime81.jsx)(Text, { size: "xs", weight: 400, children: userInfoQuery.data || (walletInfo == null ? void 0 : walletInfo.name) });
  }
  return (0, import_jsx_runtime81.jsx)(Skeleton, { width: "50px", height: "10px" });
}
function SwitchNetworkButton2(props) {
  const switchChain = useSwitchActiveWalletChain();
  const [switching, setSwitching] = (0, import_react51.useState)(false);
  const locale = props.connectLocale;
...
var ConnectModal = (props) => {
  ...
  const [hideModal, setHideModal] = (0, import_react52.useState)(false);
  const closeModal = (0, import_react52.useCallback)(() => {
    var _a;
  ...
  const setModalVisibility = (0, import_react52.useCallback)((value) => setHideModal(!value), []);
  (0, import_react52.useEffect)(() => {
...
function ConnectButton(props) {
  ...
  const wallets = (0, import_react53.useMemo)(() => props.wallets || getDefaultWallets({
    appMetadata: props.appMetadata,
    chains: props.chains
  ...
  const size4 = (0, import_react53.useMemo)(() => {
    var _a2;
  ...
  const autoConnectComp = props.autoConnect !== false && (0, import_jsx_runtime84.jsx)(AutoConnect, { appMetadata: props.appMetadata, client: props.client, wallets, timeout: typeof props.autoConnect === "boolean" ? void 0 : (_b = props.autoConnect) == null ? void 0 : _b.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect });
  if (!localeQuery.data) {
    return (0, import_jsx_runtime84.jsxs)(AnimatedButton, { disabled: true, className: `${((_c = props.connectButton) == null ? void 0 : _c.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
  ...
  }, welcomeScreen: (_l = props.connectModal) == null ? void 0 : _l.welcomeScreen, size: size4, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets }), autoConnectComp] });
}
function ConnectButtonInner(props) {
  ...
  const activeAccount = useActiveAccount();
  const siweAuth = useSiweAuth(activeWallet, activeAccount, props.auth);
  const [showSignatureModal, setShowSignatureModal] = (0, import_react53.useState)(false);
  (0, import_react53.useEffect)(() => {
    if (!activeAccount) {
  ...
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const supportedTokens = (0, import_react53.useMemo)(() => {
  ...
  if (!activeAccount) {
    return (0, import_jsx_runtime84.jsx)(AnimatedButton, { disabled: isLoading, className: `${((_b = props.connectButton) == null ? void 0 : _b.className) || ""} ${TW_CONNECT_WALLET}`, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      fontSize: "16px",
  ...
  if (siweAuth.requiresAuth) {
    if (siweAuth.isLoading || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
      return (0, import_jsx_runtime84.jsx)(AnimatedButton, { disabled: true, className: `${((_d = props.connectButton) == null ? void 0 : _d.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
        minWidth: "165px",
        height: "50px",
...
function useTransactionCostAndData(args) {
  ...
  const [txQueryKey, setTxQueryKey] = (0, import_react54.useState)();
...
function TransactionModeScreen(props) {
  ...
  if (!transactionCostAndData || !chainData) {
    return (0, import_jsx_runtime88.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime88.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime88.jsx)(ModalHeader, { title: (metadata == null ? void 0 : metadata.name) || "Transaction" }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime88.jsxs)(Container, { children: [(metadata == null ? void 0 : metadata.image) ? (0, import_jsx_runtime88.jsx)(Img, { client, src: metadata == null ? void 0 : metadata.image, style: {
    width: "100%",
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  } }) : activeWallet ? (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", center: "both", style: {
    padding: spacing.md,
    marginBottom: spacing.md,
    borderRadius: spacing.md,
    backgroundColor: theme.colors.tertiaryBg
  }, children: [(0, import_jsx_runtime88.jsx)(WalletImage, { size: iconSize.xl, id: activeWallet.id, client }), (0, import_jsx_runtime88.jsx)("div", { style: {
    flexGrow: 1,
    borderBottom: "6px dotted",
    borderColor: theme.colors.secondaryIconColor,
    marginLeft: spacing.md,
    marginRight: spacing.md
  } }), (0, import_jsx_runtime88.jsx)(ChainIcon, { client, size: iconSize.xl, chainIconUrl: (_a = chainData.icon) == null ? void 0 : _a.url })] }) : null, (0, import_jsx_runtime88.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime88.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime88.jsx)(Text, { size: "md", color: "primaryText", weight: 700, children: "Price" }) }), (0, import_jsx_runtime88.jsx)(Container, { expand: true, children: (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime88.jsx)(TokenIcon, { chain: payUiOptions.transaction.chain, client: props.client, size: "sm", token: transactionCostAndData.token }), (0, import_jsx_runtime88.jsxs)(Text, { color: "primaryText", size: "md", weight: 700, children: [String(formatNumber(Number(toTokens(transactionCostAndData.transactionValueWei, transactionCostAndData.decimals)), 6)), " ", transactionCostAndData.token.symbol] })] }) })] }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime88.jsx)(Line, {}), (0, import_jsx_runtime88.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime88.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime88.jsx)(Text, { size: "xs", color: "secondaryText", children: "Gas Fees" }) }), (0, import_jsx_runtime88.jsx)(Container, { expand: true, children: (0, import_jsx_runtime88.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: (0, import_jsx_runtime88.jsx)(Text, { color: sponsoredTransactionsEnabled ? "success" : "primaryText", size: "xs", children: sponsoredTransactionsEnabled ? "Sponsored" : `${String(formatNumber(Number(toTokens(transactionCostAndData.gasCostWei, chainData.nativeCurrency.decimals)), 6))} ${chainData.nativeCurrency.symbol}` }) }) })] }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", children: [(0, import_jsx_runtime88.jsx)(Container, { flex: "column", expand: true, children: (0, import_jsx_runtime88.jsx)(Text, { size: "xs", color: "secondaryText", children: "Network" }) }), (0, import_jsx_runtime88.jsx)(Container, { expand: true, children: (0, import_jsx_runtime88.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: { justifyContent: "right" }, children: [(0, import_jsx_runtime88.jsx)(ChainIcon, { chainIconUrl: (_b = chainData.icon) == null ? void 0 : _b.url, size: "xs", client: props.client }), (0, import_jsx_runtime88.jsx)(Text, { size: "xs", color: "secondaryText", style: { textAlign: "right" }, children: chainData.name })] }) })] })] }), (0, import_jsx_runtime88.jsx)(Spacer, { y: "xl" }), payerAccount ? (0, import_jsx_runtime88.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
  ...
  }, children: "Choose Payment Method" }) : (0, import_jsx_runtime88.jsx)("div", { children: (0, import_jsx_runtime88.jsx)(ConnectButton, { ...props.connectOptions, client, theme, connectButton: {
    style: {
      width: "100%"
    }
  } }) })] });
...
function WalletSelectorButton(props) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime89.jsx)(Container, { bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    ...props.containerStyle
  }, children: (0, import_jsx_runtime89.jsxs)(Button, { fullWidth: true, disabled: props.disabled, onClick: props.onClick, variant: "ghost", style: {
    justifyContent: "space-between",
    padding: spacing.sm,
    backgroundColor: theme.colors.tertiaryBg
  }, gap: "sm", children: [(0, import_jsx_runtime89.jsx)(WalletRow, { client: props.client, address: props.address }), !props.disableChevron && (0, import_jsx_runtime89.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    color: theme.colors.secondaryText
  } }), props.checked && (0, import_jsx_runtime89.jsx)(CheckIcon, { width: iconSize.md, height: iconSize.md })] }) });
}
function WalletRow(props) {
  ...
  return (0, import_jsx_runtime89.jsxs)(Container, { flex: "row", center: "y", gap: "sm", color: "secondaryText", children: [ensAvatarQuery.data ? (0, import_jsx_runtime89.jsx)(Img, { src: ensAvatarQuery.data, width: iconSize.md, height: iconSize.md, style: {
    borderRadius: radius.sm
  }, client: props.client }) : walletId ? (0, import_jsx_runtime89.jsx)(WalletImage, { id: walletId, size: iconSize.md, client: props.client }) : null, (0, import_jsx_runtime89.jsx)(Text, { size: "sm", color: "primaryText", children: addressOrENS || shortenAddress(props.address) })] });
}
...
function OnrampStatusScreen(props) {
  ...
  const purchaseCbCalled = (0, import_react55.useRef)(false);
  ...
  const invalidatedBalance = (0, import_react55.useRef)(false);
  (0, import_react55.useEffect)(() => {
    var _a2;
...
function FiatFlow(props) {
  ...
  const [screen, setScreen] = (0, import_react56.useState)(hasTwoSteps ? {
    id: "step-1"
  } : {
    id: "onramp-status"
  });
  const [popupWindow, setPopupWindow] = (0, import_react56.useState)(props.openedWindow);
  const onPostOnrampSuccess = (0, import_react56.useCallback)(() => {
...
function useToTokenSelectionStates(options) {
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react57.useState)(initialTokenAmount);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const [toChain, setToChain] = (0, import_react57.useState)(
  ...
  const [toToken, setToToken] = (0, import_react57.useState)((prefillBuy == null ? void 0 : prefillBuy.token) || payOptions.mode === "direct_payment" && payOptions.paymentInfo.token || NATIVE_TOKEN);
  return {
    toChain,
    setToChain,
    toToken,
...
function useFromTokenSelectionStates(options) {
  ...
  const [fromChain_, setFromChain] = (0, import_react57.useState)();
  ...
  const [fromToken_, setFromToken] = (0, import_react57.useState)();
...
function useFiatCurrencySelectionStates(options) {
  ...
  const [selectedCurrency, setSelectedCurrency] = (0, import_react57.useState)(currencies.find((x) => x.shorthand === defaultSelectedCurrencyShorthand) || usdCurrency);
  return {
    selectedCurrency,
    setSelectedCurrency
  };
...
function TransferConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react58.useState)("transfer");
  const [status, setStatus] = (0, import_react58.useState)({ id: "idle" });
...
function TransferFlow(props) {
  const [transferTxHash, setTransferTxHash] = (0, import_react59.useState)();
  if (transferTxHash) {
...
function usePayerSetup() {
  ...
  const account = useActiveAccount();
  const activeChain = useActiveWalletChain();
  const [_payer, setPayer] = (0, import_react60.useState)();
...
function BuyScreenContent(props) {
  ...
  const [screen, setScreen] = (0, import_react61.useState)({
    id: "main"
  });
  ...
  const [hasEditedAmount, setHasEditedAmount] = (0, import_react61.useState)(false);
  const onDone = (0, import_react61.useCallback)(() => {
    setScreen({ id: "main" });
    props.onDone();
  }, [props.onDone]);
  ...
  const destinationSupportedTokens = (0, import_react61.useMemo)(() => {
  ...
  const sourceSupportedTokens = (0, import_react61.useMemo)(() => {
  ...
  const onSwapSuccess = (0, import_react61.useCallback)((_status) => {
    var _a2, _b2;
  ...
  const onFiatSuccess = (0, import_react61.useCallback)((_status) => {
    var _a2, _b2;
    (_b2 = (_a2 = props.payOptions).onPurchaseSuccess) == null ? void 0 : _b2.call(_a2, {
      type: "fiat",
      status: _status
...
function SwapScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react61.useState)("fees");
  ...
  function showSwapFlow() {
    if (props.payOptions.mode === "direct_payment" && !isNotEnoughBalance && !swapRequired) {
      setScreen({
        id: "transfer-flow"
      });
...
//# sourceMappingURL=chunk-DFCNR2DI.js.map
