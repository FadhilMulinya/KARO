...
async function sendTransaction(options) {
  ...
  if (options.transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-M3YWIWDX.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-R7WJQ27S.js");
...
//# sourceMappingURL=chunk-YXDWDMRE.js.map
