import {
  allowance
} from "./chunk-2EMIW3Q5.js";
import {
  populateEip712Transaction,
  signEip712Transaction
} from "./chunk-L3K7WXSR.js";
import {
  DEBUG,
  DUMMY_SIGNATURE,
...
import {
  parseEventLogs,
  prepareEvent
} from "./chunk-7AXORLT7.js";
import {
  approve
} from "./chunk-ZMNEMXKJ.js";
import {
  prepareContractCall
  ...
  const account = {
    ...
    async signMessage({ message }) {
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { hashMessage }, { checkContractWalletSignature }] = await Promise.all([
        import("./is-contract-deployed-FG2QFG7P.js"),
        import("./read-contract-B6WFVYMY.js"),
        import("./encodeAbiParameters-72TKOHC7.js"),
        import("./hashMessage-AIAR7CA5.js"),
        import("./checkContractWalletSignature-UA5I45FY.js")
      ]);
    ...
    async signTypedData(_typedData) {
      ...
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { checkContractWalletSignedTypedData }] = await Promise.all([
        ...
        import("./read-contract-B6WFVYMY.js"),
        import("./encodeAbiParameters-72TKOHC7.js"),
        import("./checkContractWalletSignedTypedData-JOO3PW2M.js")
      ]);
...
async function _deployAccount(args) {
  ...
  const [{ sendTransaction }, { prepareTransaction }] = await Promise.all([
    import("./send-transaction-G2H7COAN.js"),
...
//# sourceMappingURL=chunk-KOMENWKB.js.map
