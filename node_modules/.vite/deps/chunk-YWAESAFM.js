...
function createEcosystemWallet(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-SUMOUMQQ.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-SUMOUMQQ.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, {
        id,
        partnerId: createOptions == null ? void 0 : createOptions.partnerId
      });
...
function ecosystemWallet(...args) {
  ...
  return createEcosystemWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-GED3BFLQ.js");
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-JHIRDR6Q.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-JHIRDR6Q.js");
      const provider = await args.providerFactory();
  ...
  switch (true) {
    ...
    default: {
      ...
      const wallet = {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
          const { injectedProvider } = await import("./mipdStore-UT7FTXVW.js");
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-ERJGPZKS.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-MPQXETAX.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-MPQXETAX.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-ERJGPZKS.js");
...
//# sourceMappingURL=chunk-YWAESAFM.js.map
