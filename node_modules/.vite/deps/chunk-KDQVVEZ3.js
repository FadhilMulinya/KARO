...
var QueriesObserver = (_a10 = class extends Subscribable {
...
}, _client2 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _QueriesObserver_instances = new WeakSet(), combineResult_fn = function(input, combine2) {
  if (combine2) {
  ...
  const matchingObservers = defaultedQueryOptions.flatMap((defaultedOptions) => {
    ...
    if (match2 != null) {
      return [{ defaultedQueryOptions: defaultedOptions, observer: match2 }];
    }
    return [];
  });
  const matchedQueryHashes = new Set(
    matchingObservers.map((match2) => match2.defaultedQueryOptions.queryHash)
  );
...
async function parseNftUri(options) {
  ...
  switch (erc_namespace) {
    case "erc721": {
      const { getNFT } = await import("./getNFT-EU355CW5.js");
    ...
    case "erc1155": {
      const { getNFT } = await import("./getNFT-B35RKNZI.js");
      const nft = await getNFT({
        contract,
        tokenId: BigInt(tokenID)
      });
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KDQVVEZ3.js.map
