...
function __rest(s3, e2) {
  ...
  if (s3 != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i3 = 0, p2 = Object.getOwnPropertySymbols(s3); i3 < p2.length; i3++) {
      if (e2.indexOf(p2[i3]) < 0 && Object.prototype.propertyIsEnumerable.call(s3, p2[i3]))
        t[p2[i3]] = s3[p2[i3]];
    }
  return t;
}
function __decorate(decorators, target, key, desc) {
  ...
  else for (var i3 = decorators.length - 1; i3 >= 0; i3--) if (d2 = decorators[i3]) r3 = (c4 < 3 ? d2(r3) : c4 > 3 ? d2(target, key, r3) : d2(target, key)) || r3;
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_3) try {
      if (f3 = 1, y4 && (t = op[0] & 2 ? y4["return"] : op[0] ? y4["throw"] || ((t = y4["return"]) && t.call(y4), 0) : y4.next) && !(t = t.call(y4, op[1])).done) return t;
...
function __values(o4) {
  var s3 = typeof Symbol === "function" && Symbol.iterator, m2 = s3 && o4[s3], i3 = 0;
...
function __read(o4, n4) {
  ...
  try {
    ...
    try {
      if (r3 && !r3.done && (m2 = i3["return"])) m2.call(i3);
    } finally {
...
function __asyncDelegator(o4) {
  ...
  function verb(n4, f3) {
    i3[n4] = o4[n4] ? function(v2) {
      return (p2 = !p2) ? { value: __await(o4[n4](v2)), done: n4 === "return" } : f3 ? f3(v2) : v2;
    } : f3;
  }
}
function __asyncValues(o4) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var m2 = o4[Symbol.asyncIterator], i3;
  return m2 ? m2.call(o4) : (o4 = typeof __values === "function" ? __values(o4) : o4[Symbol.iterator](), i3 = {}, verb("next"), verb("throw"), verb("return"), i3[Symbol.asyncIterator] = function() {
    return this;
  }, i3);
  function verb(n4) {
    i3[n4] = o4[n4] && function(v2) {
    ...
    function hashBlocks(w3, v2, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i3 = 0; i3 < 16; i3++) {
          var j2 = pos + i3 * 4;
          w3[i3] = binary_1.readUint32BE(p2, j2);
        }
        ...
        for (var i3 = 0; i3 < 64; i3++) {
          var t1 = (((e2 >>> 6 | e2 << 32 - 6) ^ (e2 >>> 11 | e2 << 32 - 11) ^ (e2 >>> 25 | e2 << 32 - 25)) + (e2 & f3 ^ ~e2 & g2) | 0) + (h4 + (K2[i3] + w3[i3] | 0) | 0) | 0;
          var t2 = ((a3 >>> 2 | a3 << 32 - 2) ^ (a3 >>> 13 | a3 << 32 - 13) ^ (a3 >>> 22 | a3 << 32 - 22)) + (a3 & b3 ^ a3 & c4 ^ b3 & c4) | 0;
          h4 = g2;
          g2 = f3;
          f3 = e2;
          e2 = d2 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function add(o4, a3, b3) {
      for (let i3 = 0; i3 < 16; i3++) {
        o4[i3] = a3[i3] + b3[i3];
      }
    }
    function sub(o4, a3, b3) {
      for (let i3 = 0; i3 < 16; i3++) {
        o4[i3] = a3[i3] - b3[i3];
      }
    }
    function mul(o4, a3, b3) {
    ...
    function scalarMult(n4, p2) {
      ...
      const a3 = gf(), b3 = gf(), c4 = gf(), d2 = gf(), e2 = gf(), f3 = gf();
  ...
  "node_modules/bn.js/lib/bn.js"(exports, module) {
    (function(module2, exports2) {
      ...
      function parseHex4Bits(string2, index) {
        var c4 = string2.charCodeAt(index);
        if (c4 >= 65 && c4 <= 70) {
          return c4 - 55;
      ...
      BN.prototype.toString = function toString3(base3, padding) {
        ...
        if (base3 === (base3 | 0) && base3 >= 2 && base3 <= 36) {
          ...
          c4.negative = 0;
          while (!c4.isZero()) {
            var r3 = c4.modn(groupBase).toString(base3);
      ...
      FFTM.prototype.makeRBT = function makeRBT(N10) {
        ...
        for (var i3 = 0; i3 < N10; i3++) {
          t[i3] = this.revBin(i3, l4, N10);
        }
        return t;
      };
      FFTM.prototype.revBin = function revBin(x3, l4, N10) {
      ...
      FFTM.prototype.transform = function transform(rws, iws, rtws, itws, N10, rbt) {
        ...
        for (var s3 = 1; s3 < N10; s3 <<= 1) {
          ...
          for (var p2 = 0; p2 < N10; p2 += l4) {
            var rtwdf_ = rtwdf;
            var itwdf_ = itwdf;
            for (var j2 = 0; j2 < s3; j2++) {
              var re = rtws[p2 + j2];
              var ie = itws[p2 + j2];
              var ro = rtws[p2 + j2 + s3];
              var io = itws[p2 + j2 + s3];
      ...
      FFTM.prototype.mulp = function mulp(x3, y4, out) {
        var N10 = 2 * this.guessLen13b(x3.length, y4.length);
        ...
        this.convert13b(y4.words, y4.length, nrws, N10);
        ...
        out.negative = x3.negative ^ y4.negative;
        out.length = x3.length + y4.length;
        return out.strip();
      };
      ...
      BN.prototype.iushln = function iushln(bits) {
        ...
        if (r3 !== 0) {
          ...
          for (i3 = 0; i3 < this.length; i3++) {
            ...
            var c4 = (this.words[i3] | 0) - newCarry << r3;
      ...
      BN.prototype._wordDiv = function _wordDiv(num, mode) {
        ...
        var diff = a3.clone()._ishlnsubmul(b3, 1, m2);
        if (diff.negative === 0) {
          a3 = diff;
          if (q) {
            q.words[m2] = 1;
        ...
        for (var j2 = m2 - 1; j2 >= 0; j2--) {
          var qj = (a3.words[b3.length + j2] | 0) * 67108864 + (a3.words[b3.length + j2 - 1] | 0);
          qj = Math.min(qj / bhi | 0, 67108863);
          a3._ishlnsubmul(b3, qj, j2);
          while (a3.negative !== 0) {
            qj--;
            a3.negative = 0;
            a3._ishlnsubmul(b3, 1, j2);
            if (!a3.isZero()) {
              a3.negative ^= 1;
            }
          }
      ...
      Red.prototype.sqrt = function sqrt(a3) {
        ...
        while (t.cmp(one) !== 0) {
          ...
          assert(i3 < m2);
          var b3 = this.pow(c4, new BN(1).iushln(m2 - i3 - 1));
          r3 = r3.redMul(b3);
          c4 = b3.redSqr();
          t = t.redMul(c4);
          m2 = i3;
      ...
      Mont.prototype.imul = function imul(a3, b3) {
        ...
        var t = a3.imul(b3);
        var c4 = t.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m);
        var u2 = t.isub(c4).iushrn(this.shift);
        var res = u2;
        if (u2.cmp(this.m) >= 0) {
          res = u2.isub(this.m);
        } else if (u2.cmpn(0) < 0) {
...
var require_short = __commonJS({
  "node_modules/elliptic/lib/elliptic/curve/short.js"(exports, module) {
    ...
    function Point(curve, x3, y4, isRed) {
    ...
    ShortCurve.prototype.point = function point(x3, y4, isRed) {
      return new Point(this, x3, y4, isRed);
    };
    ...
    Point.prototype.add = function add(p2) {
      ...
      if (this.x.cmp(p2.x) === 0)
        return this.curve.point(null, null);
      var c4 = this.y.redSub(p2.y);
      if (c4.cmpn(0) !== 0)
        c4 = c4.redMul(this.x.redSub(p2.x).redInvm());
      var nx = c4.redSqr().redISub(this.x).redISub(p2.x);
    ...
    function JPoint(curve, x3, y4, z3) {
      Base.BasePoint.call(this, curve, "jacobian");
      if (x3 === null && y4 === null && z3 === null) {
    ...
    ShortCurve.prototype.jpoint = function jpoint(x3, y4, z3) {
      return new JPoint(this, x3, y4, z3);
    };
    ...
    JPoint.prototype._zeroDbl = function _zeroDbl() {
      ...
      if (this.zOne) {
        ...
        var c4 = b3.redSqr();
        var d2 = this.x.redAdd(b3).redSqr().redISub(a3).redISub(c4);
        d2 = d2.redIAdd(d2);
    ...
    JPoint.prototype._dbl = function _dbl() {
      ...
      jyd8 = jyd8.redIAdd(jyd8);
      jyd8 = jyd8.redIAdd(jyd8);
      var ny = c4.redMul(t2).redISub(jyd8);
    ...
    JPoint.prototype.trpl = function trpl() {
      ...
      t = t.redIAdd(t);
      t = t.redIAdd(t);
      var u2 = m2.redIAdd(e2).redSqr().redISub(mm).redISub(ee).redISub(t);
      ...
      nx = nx.redIAdd(nx);
      nx = nx.redIAdd(nx);
      var ny = this.y.redMul(u2.redMul(t.redISub(u2)).redISub(e2.redMul(ee)));
      ny = ny.redIAdd(ny);
      ny = ny.redIAdd(ny);
      ny = ny.redIAdd(ny);
...
var require_edwards = __commonJS({
  "node_modules/elliptic/lib/elliptic/curve/edwards.js"(exports, module) {
    ...
    EdwardsCurve.prototype.jpoint = function jpoint(x3, y4, z3, t) {
      return this.point(x3, y4, z3, t);
    };
    ...
    function Point(curve, x3, y4, z3, t) {
      Base.BasePoint.call(this, curve, "projective");
      if (x3 === null && y4 === null && z3 === null) {
    ...
    EdwardsCurve.prototype.point = function point(x3, y4, z3, t) {
      return new Point(this, x3, y4, z3, t);
    };
    Point.fromJSON = function fromJSON(curve, obj) {
    ...
    Point.prototype._extDbl = function _extDbl() {
      ...
      c4 = c4.redIAdd(c4);
      var d2 = this.curve._mulA(a3);
      var e2 = this.x.redAdd(this.y).redSqr().redISub(a3).redISub(b3);
      var g2 = d2.redAdd(b3);
      var f3 = g2.redSub(c4);
      var h4 = d2.redSub(b3);
      var nx = e2.redMul(f3);
    ...
    Point.prototype._projDbl = function _projDbl() {
      ...
      if (this.curve.twisted) {
        ...
        var f3 = e2.redAdd(d2);
        if (this.zOne) {
          nx = b3.redSub(c4).redSub(d2).redMul(f3.redSub(this.curve.two));
          ny = f3.redMul(e2.redSub(d2));
          nz = f3.redSqr().redSub(f3).redSub(f3);
        } else {
          h4 = this.z.redSqr();
          j2 = f3.redSub(h4).redISub(h4);
          nx = b3.redSub(c4).redISub(d2).redMul(j2);
          ny = f3.redMul(e2.redSub(d2));
          nz = f3.redMul(j2);
        }
      } else {
        ...
        nx = this.curve._mulC(b3.redISub(e2)).redMul(j2);
        ny = this.curve._mulC(e2).redMul(c4.redISub(d2));
        nz = e2.redMul(j2);
      }
    ...
    Point.prototype._extAdd = function _extAdd(p2) {
      var a3 = this.y.redSub(this.x).redMul(p2.y.redSub(p2.x));
      var b3 = this.y.redAdd(this.x).redMul(p2.y.redAdd(p2.x));
      var c4 = this.t.redMul(this.curve.dd).redMul(p2.t);
    ...
    Point.prototype._projAdd = function _projAdd(p2) {
      var a3 = this.z.redMul(p2.z);
      var b3 = a3.redSqr();
      var c4 = this.x.redMul(p2.x);
      var d2 = this.y.redMul(p2.y);
      var e2 = this.curve.d.redMul(c4).redMul(d2);
      var f3 = b3.redSub(e2);
      var g2 = b3.redAdd(e2);
      var tmp = this.x.redAdd(this.y).redMul(p2.x.redAdd(p2.y)).redISub(c4).redISub(d2);
      var nx = a3.redMul(f3).redMul(tmp);
      var ny;
      var nz;
      if (this.curve.twisted) {
        ny = a3.redMul(g2).redMul(d2.redSub(this.curve._mulA(c4)));
        nz = f3.redMul(g2);
      } else {
        ny = a3.redMul(g2).redMul(d2.redSub(c4));
...
var require_utils4 = __commonJS({
  "node_modules/hash.js/lib/hash/utils.js"(exports) {
    ...
    exports.sum32 = sum32;
    function sum32_3(a3, b3, c4) {
      return a3 + b3 + c4 >>> 0;
    }
    exports.sum32_3 = sum32_3;
    function sum32_4(a3, b3, c4, d2) {
      return a3 + b3 + c4 + d2 >>> 0;
    }
    exports.sum32_4 = sum32_4;
    function sum32_5(a3, b3, c4, d2, e2) {
      return a3 + b3 + c4 + d2 + e2 >>> 0;
    }
...
var require_common2 = __commonJS({
  "node_modules/hash.js/lib/hash/sha/common.js"(exports) {
    ...
    function ft_1(s3, x3, y4, z3) {
      if (s3 === 0)
        return ch32(x3, y4, z3);
      if (s3 === 1 || s3 === 3)
        return p32(x3, y4, z3);
      if (s3 === 2)
        return maj32(x3, y4, z3);
    }
    exports.ft_1 = ft_1;
    function ch32(x3, y4, z3) {
      return x3 & y4 ^ ~x3 & z3;
    }
    exports.ch32 = ch32;
    function maj32(x3, y4, z3) {
      return x3 & y4 ^ x3 & z3 ^ y4 & z3;
    }
    exports.maj32 = maj32;
    function p32(x3, y4, z3) {
      return x3 ^ y4 ^ z3;
    }
    exports.p32 = p32;
    function s0_256(x3) {
  ...
  "node_modules/hash.js/lib/hash/sha/1.js"(exports, module) {
    ...
    SHA1.prototype._update = function _update(msg, start) {
      ...
      for (i3 = 0; i3 < W.length; i3++) {
        var s3 = ~~(i3 / 20);
        var t = sum32_5(rotl32(a3, 5), ft_1(s3, b3, c4, d2), e2, W[i3], sha1_K[s3]);
        e2 = d2;
        d2 = c4;
        c4 = rotl32(b3, 30);
        b3 = a3;
...
var require__2 = __commonJS({
  "node_modules/hash.js/lib/hash/sha/256.js"(exports, module) {
    ...
    SHA256.prototype._update = function _update(msg, start) {
      ...
      for (i3 = 0; i3 < W.length; i3++) {
        var T1 = sum32_5(h4, s1_256(e2), ch32(e2, f3, g2), this.k[i3], W[i3]);
        var T2 = sum32(s0_256(a3), maj32(a3, b3, c4));
        h4 = g2;
        g2 = f3;
        f3 = e2;
        e2 = sum32(d2, T1);
  ...
  "node_modules/hash.js/lib/hash/ripemd.js"(exports) {
    ...
    RIPEMD160.prototype._update = function update(msg, start) {
      ...
      for (var j2 = 0; j2 < 80; j2++) {
        var T2 = sum32(
          rotl32(
            sum32_4(A2, f3(j2, B2, C3, D2), msg[r3[j2] + start], K2(j2)),
            s3[j2]
          ),
          E3
        );
  ...
  "node_modules/@stablelib/sha512/lib/sha512.js"(exports) {
    ...
    function hashBlocks(wh, wl, hh, hl, m2, pos, len) {
      ...
      while (len >= 128) {
        for (var i3 = 0; i3 < 16; i3++) {
          var j2 = 8 * i3 + pos;
          wh[i3] = binary_1.readUint32BE(m2, j2);
          wl[i3] = binary_1.readUint32BE(m2, j2 + 4);
        }
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p2, q) {
      const a3 = gf(), b3 = gf(), c4 = gf(), d2 = gf(), e2 = gf(), f3 = gf(), g2 = gf(), h4 = gf(), t = gf();
      sub(a3, p2[1], p2[0]);
      sub(t, q[1], q[0]);
      mul(a3, a3, t);
      add(b3, p2[0], p2[1]);
    ...
    function modL(r3, x3) {
      ...
      for (i3 = 63; i3 >= 32; --i3) {
        ...
        for (j2 = i3 - 32, k3 = i3 - 12; j2 < k3; ++j2) {
          x3[j2] += carry - 16 * x3[i3] * L2[j2 - (i3 - 32)];
    ...
    function convertSecretKeyToX25519(secretKey) {
      ...
      d2[31] &= 127;
      d2[31] |= 64;
      const o4 = new Uint8Array(d2.subarray(0, 32));
      (0, wipe_1.wipe)(d2);
      return o4;
    }
...
var __spreadArray = function(to, from3, pack) {
  if (pack || arguments.length === 2) for (var i3 = 0, l4 = from3.length, ar; i3 < l4; i3++) {
    if (ar || !(i3 in from3)) {
...
var alphabetBytesToChars = alphabet.reduce((p2, c4, i3) => {
  p2[i3] = c4;
  return p2;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p2, c4, i3) => {
  p2[c4.codePointAt(0)] = i3;
  return p2;
}, []);
function encode2(data) {
  return data.reduce((p2, c4) => {
    p2 += alphabetBytesToChars[c4];
    return p2;
  }, "");
}
...
var f2 = class {
  ...
  register(e2 = this.url) {
    ...
    return this.url = e2, this.registering = true, new Promise((t, n4) => {
      const o4 = new URLSearchParams(e2).get("origin"), s3 = (0, esm_exports.isReactNative)() ? { headers: { origin: o4 } } : { rejectUnauthorized: !isLocalhostUrl(e2) }, i3 = new S2(e2, [], s3);
      b2() ? i3.onerror = (r3) => {
        const l4 = r3;
  ...
  onError(e2, t) {
    const n4 = this.parseError(t), o4 = n4.message || n4.toString(), s3 = formatJsonRpcError(e2, o4);
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-6AAUJ3PC.js.map
