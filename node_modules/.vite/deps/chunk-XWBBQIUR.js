...
function smartWallet(createOptions) {
  ...
  const _smartWallet = {
    ...
    autoConnect: async (options) => {
      const { connectSmartWallet } = await import("./smart-62HTPYLW.js");
    ...
    disconnect: async () => {
      account = void 0;
      chain = void 0;
      const { disconnectSmartWallet } = await import("./smart-62HTPYLW.js");
...
//# sourceMappingURL=chunk-XWBBQIUR.js.map
