...
function createEcosystemWallet(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-OPRYWBIK.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-OPRYWBIK.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, {
        id,
        partnerId: createOptions == null ? void 0 : createOptions.partnerId
      });
...
function ecosystemWallet(...args) {
  ...
  return createEcosystemWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-FXCNQPKC.js");
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-XVDWXJCB.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-XVDWXJCB.js");
      const provider = await args.providerFactory();
      ...
      const wallet = {
        ...
        autoConnect: async (options) => {
          ...
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-NT5T3CLC.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-TANFHOTE.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-TANFHOTE.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-NT5T3CLC.js");
...
//# sourceMappingURL=chunk-J5EIIN7I.js.map
