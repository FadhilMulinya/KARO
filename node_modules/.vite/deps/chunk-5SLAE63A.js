...
async function sendTransaction(options) {
  ...
  if (options.transaction.eip712) {
    const { sendEip712Transaction } = await import("./send-eip712-transaction-EBNG36PO.js");
  ...
  if (gasless) {
    const { sendGaslessTransaction } = await import("./send-gasless-transaction-ZEABYB7T.js");
...
//# sourceMappingURL=chunk-5SLAE63A.js.map
